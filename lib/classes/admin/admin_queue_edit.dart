...
class AdminQueueEdit extends StatefulWidget {
  final String? queueDocId;
  const AdminQueueEdit({Key? key, this.queueDocId}) : super(key: key);

  @override
  State<AdminQueueEdit> createState() => _AdminQueueEditState();
}

class _AdminQueueEditState extends State<AdminQueueEdit> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.grey[100],
        elevation: 0,
        title: const Text('แก้ไขรายการนัดหมาย (แอดมิน)', style: TextStyle(color: Colors.black)),
        centerTitle: true,
      ),
