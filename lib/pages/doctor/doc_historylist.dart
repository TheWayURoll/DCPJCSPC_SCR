...
import 'package:dcpjcspc_scr/widgets/history_Cards/doctor_history_card.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class DocHistorylist extends StatelessWidget {
  final String doctorId; // เพิ่มพารามิเตอร์สำหรับไอดีแพทย์
  
  const DocHistorylist({
    super.key, 
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('logHisDocId.docId', isEqualTo: doctorId)
            .snapshots(),
            ...
            return const Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16),
                  Text(
                    'ไม่มีประวัติการจองคิวของแพทย์ท่านนี้',
                    style: TextStyle(
                      fontSize: 16,
                      color: Colors.grey,
                    ),
